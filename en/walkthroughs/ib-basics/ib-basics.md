...
This file was auto-generated by RoboVM when you saved your modifications to the Java class in the IDE. It's what allows Interface Builder to get to know about our controllers, their outlets, and their actions.

Since we changed the name of the view controller, we need to reassign it to our scene:
...
When iOS loads our application, it will first load the main storyboard, which in turn will load our scene and trigger the instantiation of our `GreetingsController` class, both on the native and on the Java-side!
